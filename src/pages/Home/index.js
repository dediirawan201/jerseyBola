...
const Home = ({navigation}) => {
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={{height:responsiveHeight(125),backgroundColor:colors.main}}/>
      <View style={styles.wrapper}>
        <Header placeholder='Cari Jersey...' />
        <Gap height={15}/>
        <Carousel/>
        <Gap height={18}/>
    ...
    justifyContent: 'space-between',}}>
        {dummyJerseys.map(jersey => {
          return (
            <ListJersey key={jersey.id} gambar={jersey.gambar[0]} nama={jersey.nama} onPress={() => navigation.navigate('JerseyDetail',jersey)}/>
          )
        })}
        </View>
